...
export default function App() {
  ...
  async function saveMembros(lista) {
    await setDoc(doc(db, "config", "membros"), { lista });
    setMembros(lista);
  }
  ...
  async function handleSubmit() {
    ...
    await addAgendamento({ ...form, criadoEm: new Date().toISOString() });
    setFormSuccess(true);
